...
<div class="space-y-6">
	<div>
		<h3 class="text-lg font-medium">Register a new passkey</h3>
		<p class="text-muted-foreground text-sm">
			This will require you to use a passkey such as a fingerprint reader or a face ID. This is a cross-platform
